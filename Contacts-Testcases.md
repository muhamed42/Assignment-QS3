...
- Then Click Excute.
### Expected Result
- This test shouldn't show any test result because a valid ID is required to fetch contact details.
### Actual Result
- No actual result, since there's no action occured.
...
- The response includes the details of the specified contact.
### Actual Result
- The response includes 204 Msg of the specified contact,but the lastname for the id doesn't change.
...
- Then Click Excute.
### Expected Result
- The software accepts it since it's a financial transactions.
### Actual Result
...
```
### Steps
- Verify that the user cannot add a alphabetic character in amount to a contact's balance.
- Then Click Excute.
### Expected Result
- The Response contains an error message.
- The payment transaction isn't allowed.
### Actual Result
...
```
### Steps
- Verify that the user cannot add a special character in amount to a contact's balance.
- Then Click Excute.
### Expected Result
- The Response contains an error message.
- The payment transaction isn't allowed.
